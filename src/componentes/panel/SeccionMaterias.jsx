      ...
      {tab === 'inscripciones' && (
        <div>
          ...
          {cargando ? (
            ...
            <div className="card">
              <div className="table-head" style={{gridTemplateColumns:'2fr 1fr 1fr 1fr 1fr 110px'}}>
                <div>Materia</div><div style={{textAlign:'center'}}>Dia</div><div style={{textAlign:'center'}}>Horario</div><div style={{textAlign:'center'}}>Aula</div><div style={{textAlign:'center'}}>Comision</div><div></div>
              </div>
              {inscripciones.map(insc => (
                <div key={insc.id} className="table-row" style={{gridTemplateColumns:'2fr 1fr 1fr 1fr 1fr 110px'}}>
                  <div>
